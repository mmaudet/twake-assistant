# How to contribute to Twake Assistant?
...
- What is the version of the Twake Assistant app?
...
```
$ git clone github.com/mmaudet/twake-assistant.git
$ cd twake-assistant
$ git remote add fork git://github.com/yourusername/twake-assistant.git
```
...
Go to https://github.com/yourusername/twake-assistant and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Twake Assistant is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/mmaudet/twake-assistant/issues/new
...
[localization]: https://github.com/mmaudet/twake-assistant/blob/master/README.md#localization
