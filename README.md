[![Travis build status shield](https://img.shields.io/travis/mmaudet/twake-assistant/master.svg)](https://travis-ci.org/mmaudet/twake-assistant)
[![Github Release version shield](https://img.shields.io/github/tag/mmaudet/twake-assistant.svg)](https://github.com/mmaudet/twake-assistant/releases)
[![jest](https://facebook.github.io/jest/img/jest-badge.svg)](https://github.com/facebook/jest)


# Twake Assistant

## What's Twake Assistant?
...
Hacking the Cozy Twake Assistant app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/mmaudet/twake-assistant.git
$ cd twake-assistant
$ yarn install
```
...
After the build and the docker image launched, your app is now available at http://twake-assistant.cozy.tools:8080.
...
If you want to work on Twake Assistant and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Twake Assistant is [mmaudet](https://github.com/mmaudet), send him/her a :beers: to say hello!
...
Twake Assistant is developed by mmaudet and distributed under the [AGPL v3 license][agpl-3.0].
